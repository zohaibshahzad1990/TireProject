    ...
    public partial class NewPrintPage : ContentPage
    {
        ...
        async Task PageRun()
        {
           ...
           var font = new XFont(fontName, 20);
            ...
            ////Four Images 
            if (reportData.Pic1 != null && reportData.Pic1.Contains("http://3.133.136.76"))
            {
            ...
            if (reportData.Pic2 != null && reportData.Pic2.Contains("http://3.133.136.76"))
            {
            ...
            if (reportData.Pic3 != null && reportData.Pic3.Contains("http://3.133.136.76"))
            {
            ...
            if (reportData.Pic4 != null && reportData.Pic4.Contains("http://3.133.136.76"))
            {
            ...
            if (reportData.CustomerSign != null && reportData.CustomerSign.Contains("http://3.133.136.76"))
            {
